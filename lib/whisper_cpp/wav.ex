defmodule WhisperCpp.Wav do
  ...
  ready to feed into `WhisperCpp.Native.transcribe/3`.
  """
  ...
  rest of the library can assert that audio matches without reaching into
  ...
  defp check_format(%{sample_rate: sr}) when sr != @target_rate do
    {:error, Error.new(:invalid_request, "WAV must be 16 kHz", %{sample_rate: sr})}
  end
